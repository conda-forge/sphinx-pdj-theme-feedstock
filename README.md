About sphinx-pdj-theme-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/sphinx-pdj-theme-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sphinx-pdj-theme-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add sphinx-pdj-theme
# for installing globally
pixi global install sphinx-pdj-theme
```
...
It is possible to list all of the versions of `sphinx-pdj-theme` available on your platform:
...
```
pixi search sphinx-pdj-theme --channel conda-forge
```
